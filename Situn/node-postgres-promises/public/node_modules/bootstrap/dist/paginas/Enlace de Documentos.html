					...
					<div class="col-md-8">
						...
						<form class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-xs-8">
									<input type="text" class = "form-control input-sm" id = "Documento1"  ng-model="doc1.tc_3" ng-Keypress = "buscar('Documento1')" ng-click="setCurrent(1)"></input>
						...
						<div class="col-sm-2">
							<input type = "button" class="btn btn-default" id="cancelar" value = "Cancelar" onclick = "cancelar()" >
						</div>	
...
function ControllerAngular($scope)
 {
	...
	$scope.updateDoc = a => modificarDoc(a, $scope);//$scope.current == 1? ($scope.doc1 = a, deshabilitar('Documento1')): ($scope.doc2 = a, deshabilitar('Documento2'));
	
	$scope.updateCorrespondencias = c => $scope.correspondencias = c;
	$scope.buscar = a => busqueda(a,$scope);
	$scope.enlazar = _ => CrearEnlace($scope);
	
	$scope.editar = d => editarDoc(d, $scope);//(d == "Documento1") ? ($scope.doc1 = null, habilitar(d)) : ($scope.doc2 = null, habilitar(d));
