					...
					<div class="col-md-8">
						...
						<form class="form-horizontal">
							...
							<div class="form-group">
								<div class = "col-sm-8"> <label class="col-sm-2 control-label  text-danger">Criterio de Búsqueda</label>
								</div>
								<div class="col-xs-8">
 ...
 */
	function ME_05(id, $scope,h) //Metodo de buscar
	{
		...
		fetch( 'http://localhost:3000/api/TC/' + MB_08($scope), {  
			method: 'POST', 
			datatype:'json',
			headers: {  
				"Content-type": "application/x-www-form-urlencoded"  
			} ,
			body: MB_09($scope) + "="+ criterio
		})	 
		.then(res => res.json())
		.then(obj =>  
				$scope.$apply( _=>
	...
	function MB_08($scope)// Toma el tipo de busqueda y regresa el sufijo correspondiente a la dirección del servidor
{
...
function MB_09($scope) //Toma el criterio de busqueda y devuelve la columna que se debe buscar en la BD
{
	let op = $scope.criterio;
	switch(op)
	{
