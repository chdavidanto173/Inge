    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav" style="margin-top:7px;">
	   ...
	   <div class="col-md-8" style="margin-left:20px">
           ...
           <form class="navbar-form navbar-left">         
            ...
            <div   class="form-group ">
				<select class="form-control input-sm" id="opBusqueda" ng-model = "criterio">
					<option value="No oficio">No Oficio
         ...
         <p align="left"><p align="left"><div class="table table-bordered" style="opacity: 0.7;">
	<p align="left">
...
function ControllerAngular($scope)
 ...
 {
 console.log("Retornado de url > " + getURL($scope));
	let h3 = document.getElementById('buscar').value;
	 fetch( 'http://localhost:3000/api/TC/'+getURL($scope), {  
    method: 'POST', 
    datatype:'json',
    headers: {  
      "Content-type": "application/x-www-form-urlencoded"  
      } ,
    body: getAttr($scope) + "=" + h3
      }
	)	 
	.then(res => res.json())
